...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Case 1 model.png}
    \caption{Simple Case Model: Parallel Planes}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{case 2 model.png}
    \caption{Extended Case Model: Parallel Planes}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Case 3 model.png}
    \caption{Moderate Case Model: Perpendicular Planes}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Case 4 model.png}
    \caption{Complex Case Model: Multiple Planes}
\end{figure}

\newpage


\section{Test Heat Maps}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{case 1 heat map.png}
    \caption{Simple Case Heat Map: Parallel Planes}
    \label{fig:appB-model1}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{case 2 heat map.png}
    \caption{Extended Case Heat Map: Parallel Planes}
    \label{fig:appB-model2}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{case 3 heat map.png}
    \caption{Moderate Case Heat Map: Perpendicular Planes}
    \label{fig:appB-model3}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{case 4 heat map.png}
    \caption{Complex Case Heat Map: Multiple Planes}
    \label{fig:appB-model4}
\end{figure}
